(() => {
  ...
  function showCrazyDayLoader(detail={}) {
    ...
    crazy.innerHTML = `
      <div class="boot-crazy-title" aria-label="Crazy Final Day">
        <span style="--i:0;--wave-color:#5bc8f5">C</span><span style="--i:1;--wave-color:#6dd87a">r</span><span style="--i:2;--wave-color:#e06c6c">a</span><span style="--i:3;--wave-color:#a374f7">z</span><span style="--i:4;--wave-color:#f07dba">y</span><span class="space" style="--i:5"></span><span style="--i:6;--wave-color:#a374f7">F</span><span style="--i:7;--wave-color:#fb8c5f">i</span><span style="--i:8;--wave-color:#40e4e4">n</span><span style="--i:9;--wave-color:#5bc8f5">a</span><span style="--i:10;--wave-color:#6dd87a">l</span><span class="space" style="--i:11"></span><span style="--i:12;--wave-color:#e06c6c">D</span><span style="--i:13;--wave-color:#a374f7">a</span><span style="--i:14;--wave-color:#f07dba">y</span>
      </div>
